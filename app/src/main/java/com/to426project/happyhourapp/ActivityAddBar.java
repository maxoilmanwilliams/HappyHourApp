...
public class ActivityAddBar extends Activity implements View.OnClickListener{
    ...
    private EditText editTextBusinessName, editTextLocation,editTextHappyHourStart, editTextHappyHourEnd,
            editTextFoodType,editTextDrinkType, editTextPhone;
    ...
    public void onClick(View view) {
        ...
        if (view == buttonSubmit){
            writeNewBarRestaurant(mName,mLocation,mHappyHourStart,mHappyHourEnd,mTypeDrink,mTypeFood,mOwner,mDescription,mPhone,mBusinessUser,mLogo);
        }
    ...
    public void writeNewBarRestaurant(final String Name, String Location, String HappyHourStart, String HappyHourEnd, String TypeDrink,
        ...
        BarRestaurant newBarRestaurant = new BarRestaurant(Name,Location,HappyHourStart,HappyHourEnd,TypeDrink,TypeFood,Owner,Description,Phone,BusinessUser,Logo);

        final Intent successIntent = new Intent(this , ActivityWelcomeScreen.class);

        mDatabase.child("BarRestaurant").setValue(newBarRestaurant)
